    ...
    <div className="app-shell">
      ...
      <main id="main">
        <section className="hero">
          <div><p className="eyebrow">Phase 3 | Aircraft Intelligence</p><h1>Aircraft identity, with every claim sourced.</h1><p>Observed identifiers, dated FAA registry facts, and deterministic activity statistics without turning ownership into assumptions about operation.</p></div>
